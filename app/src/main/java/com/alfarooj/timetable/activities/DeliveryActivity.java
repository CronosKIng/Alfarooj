        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            if (lang.equals("en")) {
                ...
                TranslationHelper.translateText(msg, new TranslationHelper.TranslationCallback() {
                    @Override public void onSuccess(String translated) { Toast.makeText(DeliveryActivity.this, translated, Toast.LENGTH_LONG).show(); }
                    @Override public void onError(String error) { Toast.makeText(DeliveryActivity.this, msg, Toast.LENGTH_LONG).show(); }
                });
            }
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_PERMISSION_REQUEST);
            return;
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult.getLastLocation() != null) {
                    ...
                    if (lang.equals("en")) {
                        ...
                        Toast.makeText(DeliveryActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
                    } else {
                        TranslationHelper.translateText(errorMsg, new TranslationHelper.TranslationCallback() {
                            @Override public void onSuccess(String translated) { 
                                ...
                                Toast.makeText(DeliveryActivity.this, translated, Toast.LENGTH_SHORT).show();
                            }
                            @Override public void onError(String error) { 
                                tvStatus.setText(errorMsg);
                                Toast.makeText(DeliveryActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
                    ...
                    if (response.isSuccessful() && response.body() != null && response.body().isWithinLocation()) {
                        ...
                        if (lang.equals("en")) {
                            ...
                            TranslationHelper.translateText(errorMsg, new TranslationHelper.TranslationCallback() {
                                @Override public void onSuccess(String translated) { 
                                    tvStatus.setText(translated);
                                    Toast.makeText(DeliveryActivity.this, translated, Toast.LENGTH_LONG).show();
                                }
                                @Override public void onError(String error) { 
                                    tvStatus.setText(errorMsg);
                                    Toast.makeText(DeliveryActivity.this, errorMsg, Toast.LENGTH_LONG).show();
        ...
        if (requestCode == LOCATION_PERMISSION_REQUEST) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (lang.equals("en")) {
                    ...
                    TranslationHelper.translateText(msg, new TranslationHelper.TranslationCallback() {
                        @Override public void onSuccess(String translated) { Toast.makeText(DeliveryActivity.this, translated, Toast.LENGTH_SHORT).show(); }
                        @Override public void onError(String error) { Toast.makeText(DeliveryActivity.this, msg, Toast.LENGTH_SHORT).show(); }
                    });
                }
            } else {
