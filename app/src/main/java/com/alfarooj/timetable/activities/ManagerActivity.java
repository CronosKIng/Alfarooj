    ...
    private void checkLocationAndProceed(String eventType, String eventName) {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            TranslationHelper.translateText("Location permission required!", new TranslationHelper.TranslationCallback() {
                @Override public void onSuccess(String s) { Toast.makeText(ManagerActivity.this, s, Toast.LENGTH_LONG).show(); }
                @Override public void onError(String e) { Toast.makeText(ManagerActivity.this, "Location permission required!", Toast.LENGTH_LONG).show(); }
            });
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_PERMISSION_REQUEST);
            return;
        }
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult != null && locationResult.getLastLocation() != null) {
                    ...
                    TranslationHelper.translateText("Cannot get location. Try again.", new TranslationHelper.TranslationCallback() {
                        @Override public void onSuccess(String s) { tvStatus.setText(s); Toast.makeText(ManagerActivity.this, s, Toast.LENGTH_SHORT).show(); }
                        @Override public void onError(String e) { tvStatus.setText("Cannot get location. Try again."); Toast.makeText(ManagerActivity.this, "Cannot get location", Toast.LENGTH_SHORT).show(); }
                    });
                }
            }
        };
            ...
            .enqueue(new Callback<LocationResponse>() {
                ...
                public void onResponse(Call<LocationResponse> call, Response<LocationResponse> response) {
                    if (response.isSuccessful() && response.body() != null && response.body().isWithinLocation()) {
                        ...
                        TranslationHelper.translateText("You are NOT at the work location!", new TranslationHelper.TranslationCallback() {
                            @Override public void onSuccess(String s) { tvStatus.setText(s); Toast.makeText(ManagerActivity.this, s, Toast.LENGTH_LONG).show(); }
                            @Override public void onError(String e) { tvStatus.setText("You are NOT at the work location!"); Toast.makeText(ManagerActivity.this, "You are NOT at the work location!", Toast.LENGTH_LONG).show(); }
                        });
                    }
                }
                ...
                public void onFailure(Call<LocationResponse> call, Throwable t) {
                    TranslationHelper.translateText("Location validation failed", new TranslationHelper.TranslationCallback() {
                        @Override public void onSuccess(String s) { tvStatus.setText(s); Toast.makeText(ManagerActivity.this, s, Toast.LENGTH_SHORT).show(); }
                        @Override public void onError(String e) { tvStatus.setText("Location validation failed"); Toast.makeText(ManagerActivity.this, "Location validation failed", Toast.LENGTH_SHORT).show(); }
                    });
                }
            });
    }
            ...
            .enqueue(new Callback<AttendanceResponse>() {
                ...
                public void onResponse(Call<AttendanceResponse> call, Response<AttendanceResponse> response) {
                    if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                        TranslationHelper.translateText(eventName + " recorded!", new TranslationHelper.TranslationCallback() {
                            @Override public void onSuccess(String s) { tvStatus.setText(s); Toast.makeText(ManagerActivity.this, s, Toast.LENGTH_SHORT).show(); }
                            @Override public void onError(String e) { tvStatus.setText(eventName + " recorded!"); Toast.makeText(ManagerActivity.this, eventName + " Success!", Toast.LENGTH_SHORT).show(); }
                        });
                    } else {
                        TranslationHelper.translateText("Failed to record", new TranslationHelper.TranslationCallback() {
                            @Override public void onSuccess(String s) { tvStatus.setText(s); Toast.makeText(ManagerActivity.this, s, Toast.LENGTH_SHORT).show(); }
                            @Override public void onError(String e) { tvStatus.setText("Failed to record"); Toast.makeText(ManagerActivity.this, "Failed to record!", Toast.LENGTH_SHORT).show(); }
                        });
                    }
                }
                ...
                public void onFailure(Call<AttendanceResponse> call, Throwable t) {
                    TranslationHelper.translateText("Network error", new TranslationHelper.TranslationCallback() {
                        @Override public void onSuccess(String s) { tvStatus.setText(s); Toast.makeText(ManagerActivity.this, s, Toast.LENGTH_SHORT).show(); }
                        @Override public void onError(String e) { tvStatus.setText("Network error"); Toast.makeText(ManagerActivity.this, "Network error!", Toast.LENGTH_SHORT).show(); }
                    });
                }
            });
    }
        ...
        if (requestCode == LOCATION_PERMISSION_REQUEST) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                TranslationHelper.translateText("Location permission granted", new TranslationHelper.TranslationCallback() {
                    @Override public void onSuccess(String s) { Toast.makeText(ManagerActivity.this, s, Toast.LENGTH_SHORT).show(); }
                    @Override public void onError(String e) { Toast.makeText(ManagerActivity.this, "Location permission granted", Toast.LENGTH_SHORT).show(); }
                });
            } else {
                TranslationHelper.translateText("Location permission required!", new TranslationHelper.TranslationCallback() {
                    @Override public void onSuccess(String s) { Toast.makeText(ManagerActivity.this, s, Toast.LENGTH_LONG).show(); }
