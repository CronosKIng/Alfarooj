        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            if (lang.equals("en")) {
                ...
                TranslationHelper.translateText(msg, new TranslationHelper.TranslationCallback() {
                    @Override public void onSuccess(String translated) { Toast.makeText(ManagerActivity.this, translated, Toast.LENGTH_LONG).show(); }
                    @Override public void onError(String error) { Toast.makeText(ManagerActivity.this, msg, Toast.LENGTH_LONG).show(); }
                });
            }
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_PERMISSION_REQUEST);
            return;
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult.getLastLocation() != null) {
                    ...
                    if (lang.equals("en")) {
                        ...
                        Toast.makeText(ManagerActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
                    } else {
                        TranslationHelper.translateText(errorMsg, new TranslationHelper.TranslationCallback() {
                            @Override public void onSuccess(String translated) { 
                                ...
                                Toast.makeText(ManagerActivity.this, translated, Toast.LENGTH_SHORT).show();
                            }
                            @Override public void onError(String error) { 
                                tvStatus.setText(errorMsg);
                                Toast.makeText(ManagerActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
        ...
        ApiClient.getApiService().validateLocation(locationRequest)
            .enqueue(new Callback<LocationResponse>() {
                    ...
                    if (response.isSuccessful() && response.body() != null && response.body().isWithinLocation()) {
                        ...
                        if (lang.equals("en")) {
                            ...
                            TranslationHelper.translateText(errorMsg, new TranslationHelper.TranslationCallback() {
                                @Override public void onSuccess(String translated) { 
                                    tvStatus.setText(translated);
                                    Toast.makeText(ManagerActivity.this, translated, Toast.LENGTH_LONG).show();
                                }
                                @Override public void onError(String error) { 
                                    tvStatus.setText(errorMsg);
                                    Toast.makeText(ManagerActivity.this, errorMsg, Toast.LENGTH_LONG).show();
                ...
                public void onFailure(Call<LocationResponse> call, Throwable t) {
                    ...
                    if (lang.equals("en")) {
                        tvStatus.setText(errorMsg);
                        Toast.makeText(ManagerActivity.this, "Location validation failed", Toast.LENGTH_SHORT).show();
                    } else {
                        TranslationHelper.translateText(errorMsg, new TranslationHelper.TranslationCallback() {
                            @Override public void onSuccess(String translated) { tvStatus.setText(translated); }
            ...
            .enqueue(new Callback<AttendanceResponse>() {
                ...
                public void onResponse(Call<AttendanceResponse> call, Response<AttendanceResponse> response) {
                    if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                        ...
                        if (lang.equals("en")) {
                            tvStatus.setText(errorMsg);
                            Toast.makeText(ManagerActivity.this, "Failed to record!", Toast.LENGTH_SHORT).show();
                        } else {
                            TranslationHelper.translateText(errorMsg, new TranslationHelper.TranslationCallback() {
                                @Override public void onSuccess(String translated) { tvStatus.setText(translated); }
                                @Override public void onError(String error) { tvStatus.setText(errorMsg); }
                ...
                public void onFailure(Call<AttendanceResponse> call, Throwable t) {
                    ...
                    if (lang.equals("en")) {
                        tvStatus.setText(errorMsg);
                        Toast.makeText(ManagerActivity.this, "Network error!", Toast.LENGTH_SHORT).show();
                    } else {
                        TranslationHelper.translateText(errorMsg, new TranslationHelper.TranslationCallback() {
                            @Override public void onSuccess(String translated) { tvStatus.setText(translated); }
                            @Override public void onError(String error) { tvStatus.setText(errorMsg); }
        ...
        if (requestCode == LOCATION_PERMISSION_REQUEST) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (lang.equals("en")) {
                    ...
                    TranslationHelper.translateText(msg, new TranslationHelper.TranslationCallback() {
                        @Override public void onSuccess(String translated) { Toast.makeText(ManagerActivity.this, translated, Toast.LENGTH_SHORT).show(); }
                        @Override public void onError(String error) { Toast.makeText(ManagerActivity.this, msg, Toast.LENGTH_SHORT).show(); }
                    });
                }
            } else {
